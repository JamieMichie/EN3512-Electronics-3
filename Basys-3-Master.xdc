...
create_clock -period 1000.000 -name clockIn -waveform {0.000 500.000} [get_ports clockIn]
## Switches
...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {digiOut[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digiOut[0]}]
set_property PACKAGE_PIN W6 [get_ports {digiOut[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digiOut[1]}]
set_property PACKAGE_PIN U8 [get_ports {digiOut[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digiOut[2]}]
set_property PACKAGE_PIN V8 [get_ports {digiOut[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digiOut[3]}]
set_property PACKAGE_PIN U5 [get_ports {digiOut[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digiOut[4]}]
set_property PACKAGE_PIN V5 [get_ports {digiOut[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digiOut[5]}]
set_property PACKAGE_PIN U7 [get_ports {digiOut[6]}]
...
##Quad SPI Flash
##Note that CCLK_0 ccsnot be placed in 7 series devices. You ccs access it using the
##STARTUPE2 primitive.
...
## Configuration options, ccs be used for all designs
